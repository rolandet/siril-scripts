...
"""
Multi-Night Stacking for Siril 1.4 (PyQt6) - with Siril console integration (sirilpy) - version 3.0
...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle("OSC Multi-Night Stacking (Siril 1.4) Version 3.0")
