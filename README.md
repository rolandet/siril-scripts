...
- The mosaic functionality in Siril needs RA/DEC coordinates in the fit images in order to do platsolving. For this reason the script will more than likely not work with images that are generated by DSLR cameras.
