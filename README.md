...
- The mosaic fucntionality in Siril needs RA/DEC coordinates in the fit images in order to the platsolving. For this reason the script will more than likely no work with images that are generated by DLSR cameras.
